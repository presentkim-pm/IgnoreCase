...
namespace kim\present\ignorecase\task;
...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/IgnoreCase-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = IgnoreCase::getInstance()->getDataFolder() . ".latestCache";
	}
